...
{
    public class DeployUploadOrchestrator
    {
        ...
        public DeployUploadOrchestrator(
            ...
            Action? onStageUpdated = null)
        {
            ...
            string uploadedFile = Path.Combine(
                deploymentConfiguration.Artefact.Directory,
                $"{deploymentConfiguration.Artefact.Name}.zip");
            ...
            if (finishedStages.All(fs => fs.Status == Status.Completed))
            {
                ...
                StageModel stopServices = deployment.Stages[2];
