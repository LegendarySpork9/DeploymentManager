...
{
    public class DeployActionsOrchestrator
    {
        ...
        public DeployActionsOrchestrator(
        ...
        /// <summary>
        /// Runs a GitHub Actions artefact deployment.
        /// </summary>
            ...
            DeploymentConfigurationModel<ArtefactModel> deploymentConfiguration)
        {
            ...
            (string downloadedArtefactFile, errorMessage) = await _GitHubService.DownloadArtefact(
