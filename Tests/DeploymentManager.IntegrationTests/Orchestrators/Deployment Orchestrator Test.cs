...
namespace DeploymentManager.IntegrationTests.Orchestrators
{
    ...
    public class DeploymentOrchestratorTest
    {
        ...
        public async Task TestSetUpWithArtefactModel()
        {
            ...
            Assert.AreEqual(
                DeploymentStage.FetchArtefactFiles,
                result.Stages[2].Name);
            Assert.AreEqual(
                DeploymentStage.StopServices,
                result.Stages[3].Name);
            Assert.AreEqual(
                DeploymentStage.MoveArtefacts,
                result.Stages[4].Name);
            Assert.AreEqual(
                DeploymentStage.StartServices,
                result.Stages[5].Name);
            Assert.AreEqual(
                DeploymentStage.CleanArtefacts,
